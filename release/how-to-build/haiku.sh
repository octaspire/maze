...
echoToDefs
read -r BUILDSTR <<'EOF'
gcc-x86 -O2 -std=c99 -Wall -Wextra -DOCTASPIRE_MAZE_AMALGAMATED_IMPLEMENTATION octaspire-maze-amalgamated.c -o octaspire-maze `pkg-config --cflags --libs sdl2` -lm
EOF
echo $BUILDSTR
eval $BUILDSTR
